            ...
            "crypto" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/libcrypto-lib-armv4cpuid.o",
            ...
            "crypto/aes" =>
                {
                    "deps" =>
                        [
                            "crypto/aes/libcrypto-lib-aes-armv4.o",
                            ...
                            "crypto/aes/libcrypto-lib-bsaes-armv7.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "crypto/bn" =>
                {
                    "deps" =>
                        [
                            "crypto/bn/libcrypto-lib-armv4-gf2m.o",
                            "crypto/bn/libcrypto-lib-armv4-mont.o",
            ...
            "crypto/chacha" =>
                {
                    "deps" =>
                        [
                            "crypto/chacha/libcrypto-lib-chacha-armv4.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "crypto/ec" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/ec/libcrypto-lib-ecp_nistz256-armv4.o",
            ...
            "crypto/modes" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/modes/libcrypto-lib-ghash-armv4.o",
            ...
            "crypto/poly1305" =>
                {
                    "deps" =>
                        [
                            "crypto/poly1305/libcrypto-lib-poly1305-armv4.o",
            ...
            "crypto/sha" =>
                {
                    "deps" =>
                        [
                            "crypto/sha/libcrypto-lib-keccak1600-armv4.o",
                            "crypto/sha/libcrypto-lib-sha1-armv4-large.o",
                            "crypto/sha/libcrypto-lib-sha1_one.o",
                            "crypto/sha/libcrypto-lib-sha1dgst.o",
                            "crypto/sha/libcrypto-lib-sha256-armv4.o",
