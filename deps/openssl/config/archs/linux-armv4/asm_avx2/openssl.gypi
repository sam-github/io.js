{
  'variables': {
    ...
    'openssl_sources_linux-armv4': [
      './config/archs/linux-armv4/asm_avx2/crypto/aes/aes-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/aes/aesv8-armx.S',
      './config/archs/linux-armv4/asm_avx2/crypto/aes/bsaes-armv7.S',
      './config/archs/linux-armv4/asm_avx2/crypto/bn/armv4-gf2m.S',
      './config/archs/linux-armv4/asm_avx2/crypto/bn/armv4-mont.S',
      './config/archs/linux-armv4/asm_avx2/crypto/chacha/chacha-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/ec/ecp_nistz256-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/armv4cpuid.S',
      './config/archs/linux-armv4/asm_avx2/crypto/modes/ghash-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/modes/ghashv8-armx.S',
      './config/archs/linux-armv4/asm_avx2/crypto/poly1305/poly1305-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/sha/keccak1600-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/sha/sha1-armv4-large.S',
      './config/archs/linux-armv4/asm_avx2/crypto/sha/sha256-armv4.S',
      './config/archs/linux-armv4/asm_avx2/crypto/sha/sha512-armv4.S',
    ],
