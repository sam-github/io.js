{
  'variables': {
    ...
    'openssl_sources_linux-ppc': [
      './config/archs/linux-ppc/asm/crypto/aes/aes-ppc.s',
      './config/archs/linux-ppc/asm/crypto/aes/aesp8-ppc.s',
      './config/archs/linux-ppc/asm/crypto/aes/vpaes-ppc.s',
      './config/archs/linux-ppc/asm/crypto/bn/bn-ppc.s',
      './config/archs/linux-ppc/asm/crypto/bn/ppc-mont.s',
      './config/archs/linux-ppc/asm/crypto/chacha/chacha-ppc.s',
      './config/archs/linux-ppc/asm/crypto/ppccpuid.s',
      './config/archs/linux-ppc/asm/crypto/modes/ghashp8-ppc.s',
      './config/archs/linux-ppc/asm/crypto/poly1305/poly1305-ppc.s',
      './config/archs/linux-ppc/asm/crypto/poly1305/poly1305-ppcfp.s',
      './config/archs/linux-ppc/asm/crypto/sha/sha1-ppc.s',
      './config/archs/linux-ppc/asm/crypto/sha/sha256-ppc.s',
      './config/archs/linux-ppc/asm/crypto/sha/sha256p8-ppc.s',
      './config/archs/linux-ppc/asm/crypto/sha/sha512-ppc.s',
      './config/archs/linux-ppc/asm/crypto/sha/sha512p8-ppc.s',
    ],
