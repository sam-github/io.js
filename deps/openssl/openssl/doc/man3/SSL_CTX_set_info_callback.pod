...
=item SSL_CB_POST_HANDSHAKE_START

In TLSv1.3 this is used to signal the start of post-handshake message exchanges
such as for the exchange of session tickets, or for key updates.

=item SSL_CB_POST_HANDSHAKE_DONE

In TLSv1.3 this is used to signal the end of an exchange of post-handshake
messages such as for session tickets or key updates.
...
The SSL_CB_POST_HANDSHAKE_START and SSL_CB_POST_HANDSHAKE_DONE where first added
in OpenSSL 1.1.1b.
