...
static struct info_cb_states_st {
...
} info_cb_states[][60] = {
    {
        ...
        {SSL_CB_HANDSHAKE_DONE, NULL}, {SSL_CB_POST_HANDSHAKE_START, NULL},
        {SSL_CB_LOOP, "TWST"}, {SSL_CB_POST_HANDSHAKE_DONE, NULL},
        {SSL_CB_POST_HANDSHAKE_START, NULL}, {SSL_CB_LOOP, "TWST"},
        {SSL_CB_POST_HANDSHAKE_DONE, NULL}, {SSL_CB_EXIT, NULL},
        {SSL_CB_ALERT, NULL}, {SSL_CB_HANDSHAKE_START, NULL},
        {SSL_CB_LOOP, "PINIT "}, {SSL_CB_LOOP, "PINIT "}, {SSL_CB_LOOP, "TRCH"},
        ...
        {SSL_CB_EXIT, NULL}, {SSL_CB_POST_HANDSHAKE_START, NULL},
        {SSL_CB_LOOP, "SSLOK "}, {SSL_CB_LOOP, "SSLOK "}, {SSL_CB_LOOP, "TRST"},
        {SSL_CB_POST_HANDSHAKE_DONE, NULL},  {SSL_CB_EXIT, NULL},
        {SSL_CB_POST_HANDSHAKE_START, NULL}, {SSL_CB_LOOP, "SSLOK "},
        ...
        {SSL_CB_POST_HANDSHAKE_START, NULL}, {SSL_CB_LOOP, "SSLOK "},
        {SSL_CB_LOOP, "SSLOK "}, {SSL_CB_LOOP, "TRST"},
        {SSL_CB_POST_HANDSHAKE_DONE, NULL}, {SSL_CB_EXIT, NULL}, {0, NULL},
    }, {
...
static void sslapi_info_callback(const SSL *s, int where, int ret)
{
    ...
    /*
     * Check that, if we've got SSL_CB_HANDSHAKE_DONE or
     * SSL_CB_POST_HANDSHAKE_DONE we are not in init
     */
    if ((where & (SSL_CB_HANDSHAKE_DONE | SSL_CB_POST_HANDSHAKE_DONE))
            && SSL_in_init((SSL *)s) != 0) {
        info_cb_failed = 1;
        return;
    }
