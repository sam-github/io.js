...
// XXX(sam) assumes server handshake completes before client, true for 1.2, not
// for 1.3. Might need a rewrite for TLS1.3.
...
function onsecureConnection() {
  ...
  client = as[1];  // XXX(sam) this happens after onsecureConnect, with TLS1.3
